...
async fn test_receive_funds_into_wallet() -> Result<()> {
    setup_test(test_receive_funds_into_wallet_impl).await
}

async fn test_receive_funds_into_wallet_impl(ctx: Arc<TestContext>) -> Result<()> {
...
async fn test_records_incoming_transaction_in_history() -> Result<()> {
    setup_test(test_records_incoming_transaction_in_history_impl).await
}

async fn test_records_incoming_transaction_in_history_impl(ctx: Arc<TestContext>) -> Result<()> {
    let (main_wallet, _) = open_wallet_with_address(&ctx).await?;
...
async fn test_transfers_funds_between_wallets() -> Result<()> {
    setup_test(test_transfers_funds_between_wallets_impl).await
}

async fn test_transfers_funds_between_wallets_impl(ctx: Arc<TestContext>) -> Result<()> {
